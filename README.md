# zoot-plus-client@0.1.0-SNAPSHOT.1007.sha.5ce1b4b
...
```bash
npm install zoot-plus-client --save
```
...
*CopilotControllerApi* | [**uploadCopilot**](docs/CopilotControllerApi.md#uploadcopilotoperation) | **POST** /copilot/upload | 上传作业
...
*SiteMessageApi* | [**list**](docs/SiteMessageApi.md#list) | **GET** /message/list | 分页查询站内信
*SiteMessageApi* | [**read**](docs/SiteMessageApi.md#read) | **POST** /message/read/{id} | 标记单条站内信已读
*SiteMessageApi* | [**readAll**](docs/SiteMessageApi.md#readall) | **POST** /message/readAll | 标记全部站内信已读
*SiteMessageApi* | [**unreadCount**](docs/SiteMessageApi.md#unreadcount) | **GET** /message/unreadCount | 查询未读站内信数量
...
*UserFollowApi* | [**getStatus**](docs/UserFollowApi.md#getstatus) | **GET** /follow/status/{followUserId} | 查询关注状态
*UserFollowApi* | [**specialFollow**](docs/UserFollowApi.md#specialfollow) | **POST** /follow/special/{followUserId} | 设置特别关注
...
- [CopilotDeleteRequest](docs/CopilotDeleteRequest.md)
...
- [MaaResultFollowStatusInfo](docs/MaaResultFollowStatusInfo.md)
- [MaaResultInteger](docs/MaaResultInteger.md)
...
- [MaaResultPagedDTOSiteMessageInfo](docs/MaaResultPagedDTOSiteMessageInfo.md)
- [MaaResultString](docs/MaaResultString.md)
- [MaaResultUnit](docs/MaaResultUnit.md)
- [MaaResultUnreadMessageCountInfo](docs/MaaResultUnreadMessageCountInfo.md)
...
- [PagedDTOSiteMessageInfo](docs/PagedDTOSiteMessageInfo.md)
...
- [PrtsCUDRequest](docs/PrtsCUDRequest.md)
- [RefreshReq](docs/RefreshReq.md)
- [RegisterDTO](docs/RegisterDTO.md)
- [SendRegistrationTokenDTO](docs/SendRegistrationTokenDTO.md)
- [SiteMessageInfo](docs/SiteMessageInfo.md)
- [SubCommentsInfo](docs/SubCommentsInfo.md)
- [UnreadMessageCountInfo](docs/UnreadMessageCountInfo.md)
- [UploadCopilotRequest](docs/UploadCopilotRequest.md)
- [UserInfoUpdateDTO](docs/UserInfoUpdateDTO.md)
- [VideoCUDRequest](docs/VideoCUDRequest.md)
...
- API version: `v2.0.0`
- Package version: `0.1.0-SNAPSHOT.1007.sha.5ce1b4b`
